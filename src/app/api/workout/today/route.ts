...
export async function GET() {
  ...
  if (existingWorkout?.exercises) {
    return NextResponse.json({ workout: existingWorkout, generated: false })
  }
  ...
  try {
    ...
    if (parsed) {
      ...
      return NextResponse.json({ workout: { ...parsed, completed: false }, backup: parsed.backup, generated: true })
    }
  } catch (e) {
    console.error('Workout generation error:', e)
  }

  return NextResponse.json({ workout: null, generated: false })
}
